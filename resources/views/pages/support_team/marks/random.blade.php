    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            @if($class_type->code == 'J')
                ...
                <th>EXAM (60)</th>
            @endif
            @if($class_type->code == 'LS')
                <th>CA (20)</th>
                <th>Mid-Term(30)</th>
                <th>Final EXAM (50)</th>
            @endif
            @if($class_type->code == 'NA')
                <th>CA (20)</th>
                <th>Mid-Term(30)</th>
                <th>EXAM (50)</th>
            @endif
        ...
        @foreach($marks->sortBy('user.name') as $mk)
            ...
            @endif
                ...
                @if($class_type->code == 'NA')
                    ...
                    <td><input min="1" max="30" class="w-50 text-center" name="t2_{{ $mk->id }}" value="{{ rand(1, 30) }}" type="number"></td>
                    <td><input min="1" max="50" class="w-50 text-center" name="exm_{{ $mk->id }}" value="{{ rand(1, 50) }}" type="number"></td>
                @endif
