                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group">
                            <select class="select form-control" id="active" name="active" required data-fouc data-placeholder="Choose..">
                                <option value=""></option>
                                <option {{ ($c->active  == '1' ? 'selected' : '') }} value="1">Active</option>
                                <option {{ ($c->active  == '0' ? 'selected' : '') }} value="0">InActive</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" disabled="disabled" value="{{ $c->class_type->name ?? 'unknown' }}" title="Class Type" type="text">
                            </div>
                        </div>
