        ...
        <table width="100%">
            <tr>
                <td >
                    ...
                    {{-- <strong><span style="color: #1b0c80; font-size: 20px;">Paynesville</span></strong><br/>--}}
                    <strong><span style="color: #000; font-size: 15px;"><i>{{ ucwords($s['address']) }}</i></span></strong><br/>
                    <strong><span style="color: #000; text-decoration: underline; font-size: 15px;"><i></span></strong>
                    <br /> <br />
