    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                @endif
                @if(Qs::userIsStudent())
                    <li class="nav-item"><a href="#student-profile" class="nav-link" data-toggle="tab"><i class="icon-user"></i> My Profile</a></li>
                @endif
            </ul>
            ...
            <div class="tab-content">
                            ...
                            <div class="col-md-6">
                                <form enctype="multipart/form-data" method="post" action="{{ route('my_account.update') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="name" class="form-control" type="text" value="{{ $my->name }}">
                                        </div>
                                    </div>
                ...
                @endif
                @if(Qs::userIsStudent())
                    <div class="tab-pane fade" id="student-profile">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h3>View Full Student Record</h3>
                                @php $sr = \App\Models\StudentRecord::where('user_id', Auth::user()->id)->first(); @endphp
                                @if($sr)
                                    <a href="{{ route('students.show', Qs::hash($sr->id)) }}" class="btn btn-primary btn-lg">View My Profile</a>
                                @else
                                    <p class="text-danger">Student Record not found. Please contact admin.</p>
                                @endif
                            </div>
                        </div>
                    </div>
