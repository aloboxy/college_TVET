                    ...
                    <h6>Personal Data</h6>
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                {{--LGA--}}
                                <!--<div class="col-md-4">-->
                                <!--    <label for="lga_id">Community: </span></label>-->
                                ...
                                <tr>
                                    ...
                                    @if(Qs::userIsSuperAdmin())
                                        {{-- @if($u->user_type != 'super_admin') --}}
                                            <td>
                                            <a href="{{ route('permissions.assign', Qs::hash($u->id)) }}" class="btn btn-primary btn-sm"><i class="icon-cogs"></i> Edit Permissions</a>
                                            </td>
                                        {{-- @endif --}}
                                    @endif
                                    <td>
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                @if(Qs::userIsSuperAdmin())
                                                        ...
                                                        @if($u->status == 1)
                                                        {{--Delete--}}
                                                        <a id="{{ Qs::hash($u->id) }}" onclick="confirmDeactive(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Deactivate</a>
                                                        ...
                                                        @else
                                                        <a id="{{ Qs::hash($u->id) }}" onclick="confirmActive(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Activate</a>
                                                        <form method="post" id="item-delete-{{ Qs::hash($u->id) }}" action="{{ route('users.destroy', Qs::hash($u->id)) }}" class="hidden">@csrf @method('delete')</form>
                                                        @endif
                                                @endif
