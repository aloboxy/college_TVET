...
{{--<!-- Global stylesheets -->--}}
    ...
    <link href=" {{ asset('assets/datatables.min.css') }}" rel="stylesheet" type="text/css">
    <link href=" {{ asset('assets/datatables.css') }}" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->
...
{{-- Custom App CSS--}}
    ...
    <link href=" {{ asset('css/modern.css') }}?v={{ time() }}" rel="stylesheet" type="text/css">
