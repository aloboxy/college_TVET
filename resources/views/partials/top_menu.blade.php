<div class="navbar navbar-expand-md navbar-light">
    <div class="mt-2 mr-5">
        ...
        <h4 class="text-bold text-dark">MERTU Institute Of Health & Laboratory Sciences System</h4>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <ul class="navbar-nav">
            <li class="nav-item d-flex align-items-center mr-2">
                <a href="{{ Qs::userIsSuperAdmin() ? route('settings') : '' }}" class="btn btn-outline-dark btn-sm font-weight-semibold">
                    <i class="icon-calendar3 mr-2"></i>
                    {{ Qs::getSetting('current_session') }} Semester: {{ Qs::getSetting('Semester') }}
                </a>
            </li>
