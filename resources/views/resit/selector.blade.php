...
@section('page_title', 'Resit List')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-books mr-2"></i>Resist List</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
<div  class="card-body">
        <form method="post" action="{{ route('resit.show') }}">
        @csrf
    <div class="row">
        <div class="col-mb-2">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="subject_id" class="col-form-label font-weight-bold">Course:</label>
                <select required class="select-search form-control" id="subject_id" name="subject_id[]" multiple >
