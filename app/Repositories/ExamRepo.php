...
class ExamRepo
{
    ...
    {
        return Access::firstOrCreate($data);
    }

    public function createResit($data)
    {
        return Resit::firstOrCreate($data);
    }
    ...
    public function updateAcess($id, $data)
    {
        return Access::find($id)->update($data);
    }
    ...
    {
        return Mark::where($data)->with('grade','exam')->get();
    }

    public function getResit($data)
    {
        return Resit::where($data)->with('grade')->get();
    }
