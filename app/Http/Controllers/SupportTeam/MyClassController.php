...
class MyClassController extends Controller
{
    ...
    public function __construct(MyClassRepo $my_class, UserRepo $user)
    {
        ...
        $this->middleware('can:classes.create', ['only' => ['store']]);
        $this->middleware('can:classes.edit', ['only' => ['edit', 'update']]);
        $this->middleware('can:classes.delete', ['only' => ['destroy']]);
    ...
    {
        $data = $req->only(['name','deptcode','active']);
